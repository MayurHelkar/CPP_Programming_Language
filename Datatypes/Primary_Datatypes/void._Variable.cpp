...
//    void voidVar;   // error: variable or field 'voidVar' declared void
    ...
    voidVarPtr = &Char;     
//    cout << "*voidVarPtr : " << *voidVarPtr << ", voidVarPtr : " << voidVarPtr << " and &voidVarPtr : " << &voidVarPtr << endl; // error: variable or field 'voidVar' declared void // error: 'void*' is not a pointer-to-object type
