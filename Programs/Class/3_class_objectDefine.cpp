...
//    protected:
    public :
//    char Char;      Char = 'a'; // error: 'Char' does not name a type; did you mean 'char'?
    char Char = 'a'; 
} Char;
...
//    protected:
    public : 
//    int Int;      Int = 98452; // error: 'Int' does not name a type; did you mean 'int'?
    int Int = 98452; 
} Int;
...
//    protected:
    public : 
//    float Float;      Float = 86.532; // error: 'Float' does not name a type; did you mean 'float'?
    float Float = 86.532; 
} Float;
...
//    protected:
    public : 
//    double Double;      Double = 989.45345; // error: 'Double' does not name a type; did you mean 'double'?
